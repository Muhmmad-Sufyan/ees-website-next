            ...
            <ul className="customList customListDisc mt-2 mb-4">
              ...
              <li>
                ...
                <ul className="customList customListSquare mt-1 mb-1">
                  <li>To understand and define his/her surroundings. (Science)</li>
                  <li>To understand and creatively produce in classical Urdu. (Ehya e Urdu)</li>
                  <li>To relate teachings of Islam in his/her daily life. (Islamic Studies)</li>
                  <li>To comprehend and appreciate the cultural diversity. (Social Studies)</li>
                </ul>
              </li>
              <li>
            ...
            <div className="col-lg-8">
              <div className="services-text">
                ...
                <p>
                  ...
                  of Urdu literature. In typical textbooks, the children are given arid lessons to read, which are
                ...
                <ul className="customList customListDisc mt-1">
                  <li>The textbooks are developed with the aim to instill love of Urdu language in the heart of student.</li>
                  <li>The exercises are not there to test the memory of the students but they are designed in a way to ignite creative skills of the child and increase the competency of Urdu language.</li>
                  <li>The design of the books are appealing. Illustrations and color schemes are eye-catching.</li>
                  <li>The lessons are chosen to increase the competency and interest of Urdu language.</li>
                  <li>To keep the interest of children the lessons are written in story mode.</li>
                  <li>We have tried our best that the lessons develop adoration to the Urdu literature, aesthetics and creativity in a child.</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-12">
              <div className="services-text">
                ...
                <ul className="customList customListDisc mt-1 mb-3">
                  <li>Develop capacities supportive to the coexisting environment of a society by understanding diversity in geographical and historical backgrounds.</li>
                  <li>Develop an understanding of the history and how it affects our present and future.</li>
                  <li>Develop a relationship of human society and environment and their mutual effect.</li>
                  <li>Develop aptitude of critical thinking and logical decision making by understanding the local context.</li>
                </ul>
                <p>
          ...
          <div className="row" id="_Islamic_Studies_">
            <div className="col-lg-8">
              <div className="services-text">
                ...
                <ul className="customList customListDisc mt-1">
                  <li>We use examples from everyday life to elucidate concepts in order to persuade students to practice Islam. For this, the students&#39; intellectual degree and class level have been taken into account in such a way that the beliefs and concepts are gradually articulated.</li>
                  <li>Typically, Islamic Studies lessons, from inception to delivery, focus on conveying information. Apart from the traditional manner, we have retained the style of Islamic Studies with stories, engaging lessons and design elements rather than merely thematic lessons in our books. Furthermore, we have tried to ensure that the student understands the topic and its repercussions.</li>
                  <li>Another element of our books that distinguishes it from others is Exercises. Exercise questions in textbooks are typically used to evaluate memorization. We&#39;ve tried to make sure that students grasp the learning outcomes and fundamental concepts through practice and activities. A permanent component has also been incorporated to help students strengthen their relationship with the Quran.</li>
                </ul>
              </div>
            </div>
            <div className="col-lg-4 text-center position-relative">
